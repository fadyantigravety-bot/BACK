...
CSRF_TRUSTED_ORIGINS = os.environ.get('CSRF_TRUSTED_ORIGINS', 'https://alknesa-production.up.railway.app').split(',')
...
# --- Channels (Redis for production, InMemory for local dev) ---
